 ...
 * <p>
 * This class is a simple wrapper around the standard <code>BigDecimal</code> in
...
public class BigReal implements FieldElement<BigReal>, Comparable<BigReal>, Serializable {
	 ...
	 */
	@Override
	public BigReal divide(BigReal a) throws MathException {
		try {
			return new BigReal(d.divide(a.d, scale, roundingMode));
		} catch (ArithmeticException e) {
			// Division by zero has occurred
			throw new MathException(ExceptionTypes.DIVISION_BY_ZERO_EXCEPTION);
		}
	}
	 ...
	 */
	@Override
	public BigReal reciprocal() throws MathException {
		try {
