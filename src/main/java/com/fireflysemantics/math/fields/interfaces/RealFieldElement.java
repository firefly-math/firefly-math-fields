 ...
 * <a href="http://mathworld.wolfram.com/RealNumber.html">real</a>
...
public interface RealFieldElement<T> extends FieldElement<T> {
	 ...
	 * @param a
	 *            right hand side parameter of the operator
	 * @return this - n &times; a where n is the closest integer to this/a (the
	 *         even integer is chosen for n if this/a is halfway between two
	 *         integers)
	 */
	 ...
	 *         even integer is chosen for n if this/a is halfway between two
	 *         integers)
	 * @throws MathException[DIMENSION_MISMATCH_EXCEPTION]
	 *             if number of free parameters or orders are inconsistent
	 */
	T remainder(T a) throws MathException;
	...
	/**
	 * Get the whole number that is the nearest to the instance, or the even one
	 * if x is exactly half way between two integers.
	 * 
	 * @return a double number r such that r is an integer r - 0.5 <= this <= r
	 *         + 0.5
	 */
	T rint();
	...
	/**
	 * Compute the signum of the instance. The signum is -1 for negative
	 * numbers, +1 for positive numbers and 0 otherwise
	 * 
	...
	/**
	 * Returns the instance with the sign of the argument. A NaN {@code sign}
	...
	/**
	 * Returns the hypotenuse of a triangle with sides {@code this} and
	 * {@code y} - sqrt(<i>this</i><sup>2</sup>&nbsp;+<i>y</i><sup>2</sup>)<br/>
	 ...
	 *             if number of free parameters or orders are inconsistent
	 */
	T hypot(T y) throws MathException;
	 ...
	 *             if number of free parameters or orders are inconsistent
	 */
	T pow(T e) throws MathException;
	 ...
	 *             if number of free parameters or orders are inconsistent
	 */
	T atan2(T x) throws MathException;
	 ...
	 */
	T linearCombination(T[] a, T[] b) throws MathException;
	 ...
	 *             if arrays dimensions don't match
	 */
	T linearCombination(double[] a, T[] b) throws MathException;
	 ...
	 * @return a<sub>1</sub>&times;b<sub>1</sub> + a<sub>2</sub>&times;b
	 *         <sub>2</sub>
	 ...
	 * @return a<sub>1</sub>&times;b<sub>1</sub> + a<sub>2</sub>&times;b
	 *         <sub>2</sub> + a<sub>3</sub>&times;b<sub>3</sub>
	 ...
	 *            second factor of the third term
	 * @return a<sub>1</sub>&times;b<sub>1</sub> + a<sub>2</sub>&times;b
	 *         <sub>2</sub> + a<sub>3</sub>&times;b<sub>3</sub> + a<sub>4</sub>
	 *         &times;b<sub>4</sub>
	 * @see #linearCombination(Object, Object, Object, Object)
	 * @see #linearCombination(Object, Object, Object, Object, Object, Object)
	 */
